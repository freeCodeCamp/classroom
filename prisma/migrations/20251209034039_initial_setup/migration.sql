...
-- AddForeignKey
ALTER TABLE "Classroom" ADD CONSTRAINT "Classroom_classroomTeacherId_fkey" FOREIGN KEY ("classroomTeacherId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
