...
import getStudentActivityAndProgress from '../Util/getStudentActivityAndProgress';
...
export default function Dashboard({
  ...
  studentData.forEach(data => {
    ...
    let specificAndAll = [data.certifications, certifications];
    let summary = {
      name: data.email,
      activity: getStudentActivityAndProgress(specificAndAll)[0],
      progress: getStudentActivityAndProgress(specificAndAll)[1],
      detail: (
        <a
          // TODO:
